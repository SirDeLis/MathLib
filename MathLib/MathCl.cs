...
namespace MathLib
{
    ...
    public class Arranges
    {
        ...
        public static double ArrDet(double[,] arr)
        {
            ...
            // недочет.  можно добавить ограничение для ввода только квадратной матрицы, тк в ином случае определителя не существует
            // нет проверки матриц размером более 4*4
            else //неверный расчет определителя при матрице 1х1
            {
        ...
        public static double[,] MatrixSum(double[,] arr1, double[,] arr2)
        {
            ...
            }// не хватает else на случай если у введенных матриц строки и столбцы различны
            return (arr1);
        }
        public static double[,] MatrixMul(double[,] arr1, double[,] arr2)
        {
            ...
            return arr; // нет оганичения на условия противоречащие следующему:  arr1.GetLength(0) == arr2.GetLength(1) / число строк должно равнятся числу столбцов
        }
