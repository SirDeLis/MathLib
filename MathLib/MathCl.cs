...
namespace MathLib
{
    ...
    public class Arranges
    {
        ...
        {
            double[,] arr = { { 0 }, { 0 } };
            if (arr1.GetLength(0) == arr2.GetLength(1)) // неверное условия проверки матриц -> не правильно считает и проверяет доступность матриц
            {
                ...
                for (int i = 0; i < arr.GetLength(0); i++)
                {
                    ...
                    {
                        arr[i, y] = 0;
                        for (int k = 0; k < arr1.GetLength(1); k++) //условия проверки не верные
                        {
